...
export const ACCESSORY_TOOL_DEFINITIONS = [
  ...
  {
    name: 'ReadFile',
    description: 'Read file contents from the user home directory ($HOME). You must provide a reason. File contents are automatically ingested into memory.',
    input_schema: {
      type: 'object',
      properties: {
        reason: { type: 'string', description: 'Human-readable explanation of why this tool is being called' },
        path: { type: 'string', description: 'Absolute path under $HOME, ~/ prefix, or relative to current directory' },
  ...
  {
    name: 'Grep',
    description: 'Search files using ripgrep or grep within $HOME. You must provide a reason. Results are automatically ingested into memory.',
    input_schema: {
      type: 'object',
      properties: {
        reason: { type: 'string', description: 'Human-readable explanation of why this tool is being called' },
  ...
  {
    name: 'ReplaceFile',
    description: 'Create or replace entire file content under $HOME. You must provide a reason. File is created if it does not exist. New content is automatically ingested into memory.',
    input_schema: {
      type: 'object',
      properties: {
        reason: { type: 'string', description: 'Human-readable explanation of why this tool is being called' },
        path: { type: 'string', description: 'Absolute path under $HOME, ~/ prefix, or relative to current directory. File will be created if it does not exist' },
  ...
  {
    name: 'StrReplaceFile',
    description: 'Replace text blocks or patterns in a file under $HOME. You must provide a reason. Updated content is automatically ingested into memory.',
    input_schema: {
      type: 'object',
      properties: {
        reason: { type: 'string', description: 'Human-readable explanation of why this tool is being called' },
...
export { readFileTool, grepTool, replaceFileTool, strReplaceFileTool };
